...
const CRITICAL_LABEL: Record<Criticality, string> = {
  ...
  "Future Play Holdings":                  {canonical:"Future Play (Marketing)",         category:"MARKETING",     critical:"LOW"},
  "FACEBOOK INDIA ONLINE SERVICES PRIVATE LIMITED": {canonical:"Facebook Ads",                    category:"MARKETING",     critical:"MEDIUM"},
  "Repcus Labs Pvt. Ltd.":                 {canonical:"Repcus Labs (Marketing)",         category:"MARKETING",     critical:"LOW"},
  "Rising Startup":                        {canonical:"Rising Startup (Marketing)",      category:"MARKETING",     critical:"LOW"},
  "SWASTIKA FILMS":                        {canonical:"Swastika Films (Marketing)",      category:"MARKETING",     critical:"LOW"},
  "Chamber for Advancement of Small & Medium Businesses": {canonical:"CASMB (Marketing)",               category:"MARKETING",     critical:"LOW"},
  "WEWORK":                                {canonical:"WeWork (Marketing)",              category:"MARKETING",     critical:"LOW"},
  "Abhishek - Photographer / Filmmaker":   {canonical:"Abhishek (Photographer)",         category:"MARKETING",     critical:"LOW"},
  "QUICKREPLY TECHNOLOGIES INDIA PRIVATE LIMITED": {canonical:"QuickReply (Marketing)",          category:"MARKETING",     critical:"LOW"},
  "AMAZON SELLER - ADS SPENT":             {canonical:"Amazon Ads",                      category:"MARKETING",     critical:"MEDIUM"},
  "ABDUL KALEEM ELECTRICALS":              {canonical:"Abdul Kaleem (Electrician)",      category:"R&M",           critical:"MEDIUM"},
  "Kadir Wood Work":                       {canonical:"Kadir (Carpenter)",               category:"R&M",           critical:"LOW"},
  "NANDISH COMMUNICATION":                 {canonical:"Nandish (R&M)",                   category:"R&M",           critical:"LOW"},
  "Navya Enterprises":                     {canonical:"Navya (R&M)",                     category:"R&M",           critical:"LOW"},
  "R.D. SINGAL & CO.":                     {canonical:"RD Singal (Machine Repair)",      category:"R&M",           critical:"MEDIUM"},
  "Narrayani Packaging":                   {canonical:"Narayani (Packaging)",            category:"PACKAGING",     critical:"CRITICAL"},
  "LABELS INC":                            {canonical:"Labels Inc (Stickers)",           category:"PACKAGING",     critical:"MEDIUM"},
  "OM BABOSA":                             {canonical:"Om Babosa (Packaging)",           category:"PACKAGING",     critical:"MEDIUM"},
  "AUM INTERNATIONAL TAPES PVT. LTD.":     {canonical:"Aum Tapes (Packaging)",           category:"PACKAGING",     critical:"MEDIUM"},
  "M/S. NEELKANTH POLYMERS":               {canonical:"Neelkanth Polymers (Packaging)",  category:"PACKAGING",     critical:"MEDIUM"},
  "Securement Packaging Private Limited":  {canonical:"Securement (Packaging)",          category:"PACKAGING",     critical:"MEDIUM"},
  "BS FOOD AND BEVERAGE":                  {canonical:"BS Food (Packaging)",             category:"PACKAGING",     critical:"MEDIUM"},
  "Rajesh Tempo Services":                 {canonical:"Rajesh Tempo (Logistics)",        category:"LOGISTICS",     critical:"LOW"},
  "H. M. ENTERPRISES":                     {canonical:"HM Enterprises (Logistics)",      category:"LOGISTICS",     critical:"MEDIUM"},
  "Dcluttr":                               {canonical:"Dcluttr (Tech)",                  category:"PROFESSIONAL",  critical:"LOW"},
  "Abox Agency Digital Private Limited":   {canonical:"Abox (Web Dev)",                  category:"PROFESSIONAL",  critical:"LOW"},
  "CX Voice Technology Private Limited (RevQ)": {canonical:"RevQ (Tech)",                     category:"PROFESSIONAL",  critical:"LOW"},
  "ZOHO Corporation Private Limited":      {canonical:"Zoho (Software)",                 category:"PROFESSIONAL",  critical:"MEDIUM"},
  "SS KISAN BANDHU PVT LTD":               {canonical:"SS Kisan Bandhu (RM)",            category:"RAW MATERIAL",  critical:"CRITICAL"},
  "BAJAJ GENERAL INSURANCE LIMITED":       {canonical:"Bajaj Insurance",                 category:"INSURANCE",     critical:"MEDIUM"},
  "Jet compressors & pumps":               {canonical:"Jet Compressors (Machinery)",     category:"MACHINERY",     critical:"ONE-TIME"},
  "Cook Chef Equipments India":            {canonical:"Cook Chef (Machinery)",           category:"MACHINERY",     critical:"ONE-TIME"},
  "SHRI SAI INTERNATIONAL CO.":            {canonical:"Shri Sai (Machinery)",            category:"MACHINERY",     critical:"ONE-TIME"},
  "Sanjay Kunwar Hotel Supply":            {canonical:"Sanjay Kunwar (Machinery)",       category:"MACHINERY",     critical:"ONE-TIME"},
  "Shubham Jain":                          {canonical:"Shubham Jain (Consultant)",       category:"PROFESSIONAL",  critical:"LOW"},
  "Nirmala Singh Advocate":                {canonical:"Nirmala Singh (Legal)",           category:"PROFESSIONAL",  critical:"LOW"},
  "Garg Mukesh & Co.":                     {canonical:"Garg Mukesh (Consultant)",        category:"PROFESSIONAL",  critical:"LOW"},
  "A PAREEK & ASSOCIATES":                 {canonical:"A Pareek (Consultant)",           category:"PROFESSIONAL",  critical:"LOW"},
  "GRANTH FINSHARK CONSULTANTS":           {canonical:"Granth Finshark (Consultant)",    category:"PROFESSIONAL",  critical:"LOW"},
  "Devender Singh Rent Office (New)":      {canonical:"Devender Singh (Office Rent)",    category:"RENT",          critical:"CRITICAL"},
  "Z CLASSIC UNIFORM":                     {canonical:"Z Classic (Staff Uniform)",       category:"ADMIN",         critical:"LOW"},
  "BHASIN BROTHERS":                       {canonical:"Bhasin Bros (Staff Merch)",       category:"ADMIN",         critical:"LOW"},
  "BSES ELECTRICITY":                      {canonical:"BSES Electricity",                category:"UTILITIES",     critical:"CRITICAL"},
  "ATRIA CONVERGENCE TECHNOLOGIES LIMITED": {canonical:"ACT WiFi",                        category:"UTILITIES",     critical:"MEDIUM"},
  "BHARTI AIRTEL LIMITED":                 {canonical:"Airtel WiFi",                     category:"UTILITIES",     critical:"MEDIUM"},
  "IB MONOTARO PRIVATE LIMITED":           {canonical:"IB Monotaro (Kitchen)",           category:"RAW MATERIAL",  critical:"MEDIUM"},
  "VIBHU KITCHEN EQUIPMENTS":              {canonical:"Vibhu (Kitchen)",                 category:"RAW MATERIAL",  critical:"LOW"},
  "SHREEJEE CROCKERY HOUSE":               {canonical:"Shreejee (Kitchen)",              category:"RAW MATERIAL",  critical:"LOW"},
  "EP ELECTRONIC PARADISE PRIVATE LIMITED": {canonical:"EP Electronics (Admin)",          category:"ADMIN",         critical:"LOW"},
  "MODCARE ENTERPRISES":                   {canonical:"Modcare (Stationery)",            category:"ADMIN",         critical:"LOW"},
  "Shanky Steel furniture":                {canonical:"Shanky Steel (Furniture)",        category:"ADMIN",         critical:"LOW"},
  "VS Retail":                             {canonical:"VS Retail (Gifts)",               category:"ADMIN",         critical:"LOW"},
  "RUDRAKSH FIRE N SAFETY WORLD":          {canonical:"Rudraksh (Fire Safety)",          category:"ADMIN",         critical:"LOW"},
  "AURA":                                  {canonical:"Aura (Travel)",                   category:"ADMIN",         critical:"LOW"},
